...
short_description: '*WEATHER UPDATE: The BASF is still on, but due to recent weather forecasts and the chance of heavy winds and rain, we have decided to move the event indoors. We still look forward to seeing you all there!*'
details:
  -
    type: paragraph
    content:
